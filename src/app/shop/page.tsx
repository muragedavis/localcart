      ...
      <div className="container py-10">
        ...
        {error && (
          <div className="text-center py-20">
            <div className="w-14 h-14 bg-red-50 dark:bg-red-900/30 flex items-center justify-center mx-auto mb-4">
        ...
        {!loading && !error && filtered.length === 0 && (
          <div className="text-center py-20">
            <div className="w-14 h-14 bg-gray-100 dark:bg-gray-800 flex items-center justify-center mx-auto mb-5">
            ...
            <p className="text-sm font-black uppercase tracking-widest text-gray-700 dark:text-gray-300 mb-1">No products found</p>
