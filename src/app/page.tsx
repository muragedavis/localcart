...
export default function Home() {
  ...
  return (
    <div className="overflow-x-hidden bg-white dark:bg-gray-900">
        ...
        <section className="section bg-white dark:bg-gray-900">
          <div className="container">
            <div className="text-center mb-14">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-gray-100 tracking-tight mb-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {features.map((f, i) => (
                <div key={f.title}
                  className="group p-7 rounded-2xl border border-gray-100 dark:border-gray-700 bg-white dark:bg-gray-800 hover:shadow-lg hover:-translate-y-1 hover:border-gray-200 dark:hover:border-gray-600 transition-all duration-300 relative overflow-hidden">
                  ...
                  <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-2 text-[15px]">{f.title}</h3>
      ...
      {/* ── FEATURED PRODUCTS ── */}
      <section className="section bg-gray-50/60 dark:bg-gray-800/50">
        <div className="container">
          <div className="flex items-end justify-between mb-10">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-gray-100 tracking-tight">Featured Products</h2>
            </div>
            <Link href="/shop"
        ...
        <section className="section bg-white dark:bg-gray-900">
          <div className="container">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              {testimonials.map((t) => (
                <div key={t.name}
                  className="group p-7 rounded-2xl border border-gray-100 dark:border-gray-700 bg-white dark:bg-gray-800 hover:shadow-lg hover:-translate-y-0.5 hover:border-gray-200 dark:hover:border-gray-600 transition-all duration-300 relative overflow-hidden">
                  {/* Quote mark */}
                  <div className="absolute top-4 right-6 text-7xl font-serif leading-none pointer-events-none select-none opacity-[0.04] text-gray-900 dark:text-gray-100">"</div>
                  <div className="flex items-center justify-between mb-5">
                    <StarRating count={t.rating} />
                    <span className="text-[10px] font-medium text-gray-400 uppercase tracking-wider">{t.location}</span>
                  </div>
                  <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed mb-6 italic">&ldquo;{t.text}&rdquo;</p>
      ...
      {/* ── PARTNERS ── */}
      {showPartners && (
        <section className="section-sm border-t border-b border-gray-100 dark:border-gray-800 bg-gray-50/60 dark:bg-gray-800/50">
          <div className="container">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 md:gap-6">
              {partners.map((p) => (
                <div key={p.name}
                  className="flex items-center gap-2.5 px-5 py-3 rounded-xl bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 shadow-sm hover:shadow-md hover:-translate-y-0.5 hover:border-gray-200 dark:hover:border-gray-600 transition-all duration-200 cursor-default">
